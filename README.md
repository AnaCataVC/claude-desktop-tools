...
Download the latest `ClaudeDesktopToolsSetup-1.4.0.exe` from [GitHub Releases](https://github.com/AnaCataVC/claude-desktop-tools/releases) and follow the modern setup wizard.
...
Descarga el archivo `ClaudeDesktopToolsSetup-1.4.0.exe` desde [GitHub Releases](https://github.com/AnaCataVC/claude-desktop-tools/releases) y sigue el asistente interactivo.
