...
[![xUnit](https://img.shields.io/badge/Tests-xUnit%20(60%20passing)-brightgreen)](https://xunit.net/)
...
└── ClaudeDesktopTools.Tests/         # Pure .NET 9 xUnit Test Suite (60 tests passing)
```

### Installation & Local Setup
#### Option 1: Official Windows Installer (Recommended)
Download the latest `ClaudeDesktopToolsSetup-1.1.0.exe` from [GitHub Releases](https://github.com/AnaCataVC/claude-desktop-tools/releases) and follow the modern setup wizard.
...
# Run automated tests (60 passing)
...
Descarga el archivo `ClaudeDesktopToolsSetup-1.1.0.exe` desde [GitHub Releases](https://github.com/AnaCataVC/claude-desktop-tools/releases) y sigue el asistente interactivo.
...
# Ejecutar la suite de 60 pruebas unitarias
dotnet test ClaudeDesktopTools.sln
